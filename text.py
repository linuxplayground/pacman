...
class TextGroup(object):
    ...
    def setupText(self):
        size = TILEHIGHT
        self.alltext[SCORETEXT] = Text("0".zfill(8), WHITE, 0, TILEHIGHT, size)
        self.alltext[LEVELTEXT] = Text(str(1).zfill(3), WHITE, 23*TILEWIDTH, TILEHIGHT, size)
        self.alltext[READYTEXT] = Text("READY!", YELLOW, 11.25*TILEWIDTH, 20*TILEHIGHT, size, visible=False)
        self.alltext[PAUSETEXT] = Text("PAUSED!", YELLOW, 10.625*TILEWIDTH, 20*TILEHIGHT, size, visible=False)
        self.alltext[GAMEOVERTEXT] = Text("GAMEOVER!", YELLOW, 10*TILEWIDTH, 20*TILEHIGHT, size, visible=False)
