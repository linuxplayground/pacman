...
class Spritesheet(object):
    def __init__(self):
        ...
        height = int(self.sheet.get_height() / BASETILEHEIGHT * TILEHIGHT)
...
class PacmanSprites(Spritesheet):
    ...
    def getImage(self, x, y):
        return Spritesheet.getImage(self, x, y, 2*TILEWIDTH, 2*TILEHIGHT)
...
class GhostSprites(Spritesheet):
    ...
    def update(self, dt):
        ...
        elif self.entity.mode.current == FRIEGHT:
...
class MazeSprites(Spritesheet):
    ...
    def getImage(self, x, y):
        return Spritesheet.getImage(self, x, y, TILEWIDTH, TILEHIGHT)
        ...
        for row in list(range(self.data.shape[0])):
            for col in list(range(self.data.shape[1])):
                if self.data[row][col].isdigit():
                    ...
                    background.blit(sprite, (col*TILEWIDTH, row*TILEHIGHT))
